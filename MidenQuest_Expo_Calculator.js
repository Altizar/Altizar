...
var MQO_Expo_Calc = {
    ...
    parse_resources: function () {
        ...
        this.resources.rez_ore_1 = this.parse_value(jQuery('#T1Ore', '#price_modal').text());
        this.resources.rez_ore_2 = this.parse_value(jQuery('#T2Ore', '#price_modal').text());
        this.resources.rez_ore_3 = this.parse_value(jQuery('#T3Ore', '#price_modal').text());
        this.resources.rez_ore_4 = this.parse_value(jQuery('#T4Ore', '#price_modal').text());
        this.resources.rez_ore_5 = this.parse_value(jQuery('#T5Ore', '#price_modal').text());
        this.resources.rez_plants_1 = this.parse_value(jQuery('#T1Gather', '#price_modal').text());
        this.resources.rez_plants_2 = this.parse_value(jQuery('#T2Gather', '#price_modal').text());
        this.resources.rez_plants_3 = this.parse_value(jQuery('#T3Gather', '#price_modal').text());
        this.resources.rez_plants_4 = this.parse_value(jQuery('#T4Gather', '#price_modal').text());
        this.resources.rez_plants_5 = this.parse_value(jQuery('#T5Gather', '#price_modal').text());
        this.resources.rez_wood_1 = this.parse_value(jQuery('#T1Wood', '#price_modal').text());
        this.resources.rez_wood_2 = this.parse_value(jQuery('#T2Wood', '#price_modal').text());
        this.resources.rez_wood_3 = this.parse_value(jQuery('#T3Wood', '#price_modal').text());
        this.resources.rez_wood_4 = this.parse_value(jQuery('#T4Wood', '#price_modal').text());
        this.resources.rez_wood_5 = this.parse_value(jQuery('#T5Wood', '#price_modal').text());
        this.resources.rez_fish_1 = this.parse_value(jQuery('#T1Fish', '#price_modal').text());
        this.resources.rez_fish_2 = this.parse_value(jQuery('#T2Fish', '#price_modal').text());
        this.resources.rez_fish_3 = this.parse_value(jQuery('#T3Fish', '#price_modal').text());
        this.resources.rez_fish_4 = this.parse_value(jQuery('#T4Fish', '#price_modal').text());
        this.resources.rez_fish_5 = this.parse_value(jQuery('#T5Fish', '#price_modal').text());
        this.save();
        this.buildExpos();
    },
