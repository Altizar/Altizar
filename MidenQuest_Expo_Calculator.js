...
var MQO_Expo_Calc = {
    ...
    parse_resources: function () {
        ...
        this.resources.rez_ore_1 = parseInt(jQuery('#T1Ore', '#price_modal').text());
        this.resources.rez_ore_2 = parseInt(jQuery('#T2Ore', '#price_modal').text());
        this.resources.rez_ore_3 = parseInt(jQuery('#T3Ore', '#price_modal').text());
        this.resources.rez_ore_4 = parseInt(jQuery('#T4Ore', '#price_modal').text());
        this.resources.rez_ore_5 = parseInt(jQuery('#T5Ore', '#price_modal').text());
        this.resources.rez_plants_1 = parseInt(jQuery('#T1Gather', '#price_modal').text());
        this.resources.rez_plants_2 = parseInt(jQuery('#T2Gather', '#price_modal').text());
        this.resources.rez_plants_3 = parseInt(jQuery('#T3Gather', '#price_modal').text());
        this.resources.rez_plants_4 = parseInt(jQuery('#T4Gather', '#price_modal').text());
        this.resources.rez_plants_5 = parseInt(jQuery('#T5Gather', '#price_modal').text());
        this.resources.rez_wood_1 = parseInt(jQuery('#T1Wood', '#price_modal').text());
        this.resources.rez_wood_2 = parseInt(jQuery('#T2Wood', '#price_modal').text());
        this.resources.rez_wood_3 = parseInt(jQuery('#T3Wood', '#price_modal').text());
        this.resources.rez_wood_4 = parseInt(jQuery('#T4Wood', '#price_modal').text());
        this.resources.rez_wood_5 = parseInt(jQuery('#T5Wood', '#price_modal').text());
        this.resources.rez_fish_1 = parseInt(jQuery('#T1Fish', '#price_modal').text());
        this.resources.rez_fish_2 = parseInt(jQuery('#T2Fish', '#price_modal').text());
        this.resources.rez_fish_3 = parseInt(jQuery('#T3Fish', '#price_modal').text());
        this.resources.rez_fish_4 = parseInt(jQuery('#T4Fish', '#price_modal').text());
        this.resources.rez_fish_5 = parseInt(jQuery('#T5Fish', '#price_modal').text());
        this.save();
        this.buildExpos();
    },
    buildExpos: function () {
