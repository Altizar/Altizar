...
//            MiddenQuest_Expo_Tracker.message = "<span style='color:blue;cursor: pointer;' onClick=\"sendRequestContentFill('getExpedition.aspx?null='); fightengaged = 0;\">Finished</div>";
    ...
    start: function () {
        ...
        jQuery('#TopScreen').prepend('<div id="quest_done" style="position: absolute;left: -120px;top: 480px;color: black;" class=""><div style="width:100px; height:80px; background-color:#CCC; text-align: center; border-radius: 5px; border: 1px solid black;"><br/><div>Quest Counter</div><br/><div><span id="QuestCount">1 549 SP</span></div></div></div>');
